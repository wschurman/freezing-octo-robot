...
public class QuestionClassLearner {
	...
	public QuestionClassLearner(String trainFile){
		file = trainFile;
		pipeline = null;
	...
	public String getClass(String question, String actual){
		...
		String ret = getClass(question, best, 3.2, 0.4 ).split(":")[0];
		if(ret.equalsIgnoreCase(actual)){
			return "1";
		}
		return "0";
//		
...
//				return "";
	...
	//					String knownClass = line.substring(0, split);
	//					String question = line.substring(split+1);
	//					String ret = qcl.getClass(question, word, pos);
